...
import (
	...
	"github.com/hashicorp/cdktf-provider-kubernetes-go/kubernetes/v3/mutatingwebhookconfigurationv1/internal"
...
func (m *jsiiProxy_MutatingWebhookConfigurationV1WebhookRuleOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
