...
import (
	...
	"github.com/hashicorp/cdktf-provider-kubernetes-go/kubernetes/v3/storageclass/internal"
...
func (j *jsiiProxy_StorageClass) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_StorageClass)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
