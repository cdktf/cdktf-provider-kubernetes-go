...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLivenessProbeHttpGetOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecTemplateSpecInitContainerLivenessProbeHttpGetOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
