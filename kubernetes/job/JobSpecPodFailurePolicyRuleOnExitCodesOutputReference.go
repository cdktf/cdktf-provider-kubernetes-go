...
func (j *jsiiProxy_JobSpecPodFailurePolicyRuleOnExitCodesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobSpecPodFailurePolicyRuleOnExitCodesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
