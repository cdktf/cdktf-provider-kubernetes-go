// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for kubernetes.
...
// You can continue to use the kubernetes provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12
