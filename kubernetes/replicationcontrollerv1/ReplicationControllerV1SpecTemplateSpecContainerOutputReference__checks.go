...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerOutputReference) validatePutVolumeDeviceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ReplicationControllerV1SpecTemplateSpecContainerVolumeDevice; received %#v (a %T)", value, value)
		}
	}
...
func (r *jsiiProxy_ReplicationControllerV1SpecTemplateSpecContainerOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
