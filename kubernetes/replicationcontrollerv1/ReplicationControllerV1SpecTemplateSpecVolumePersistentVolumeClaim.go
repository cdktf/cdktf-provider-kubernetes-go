...
type ReplicationControllerV1SpecTemplateSpecVolumePersistentVolumeClaim struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.0/docs/resources/replication_controller_v1#claim_name ReplicationControllerV1#claim_name}
