...
type ReplicationControllerV1SpecTemplateSpecVolumeNfs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.36.0/docs/resources/replication_controller_v1#server ReplicationControllerV1#server}
