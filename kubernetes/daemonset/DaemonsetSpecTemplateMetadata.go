...
type DaemonsetSpecTemplateMetadata struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.34.0/docs/resources/daemonset#generate_name Daemonset#generate_name}
