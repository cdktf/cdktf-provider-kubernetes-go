...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerStartupProbeHttpGetOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DaemonSetV1SpecTemplateSpecInitContainerStartupProbeHttpGetOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
