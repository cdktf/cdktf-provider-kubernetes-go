...
type StatefulSetSpecTemplateSpecVolumeProjectedSources struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/stateful_set#service_account_token StatefulSet#service_account_token}
