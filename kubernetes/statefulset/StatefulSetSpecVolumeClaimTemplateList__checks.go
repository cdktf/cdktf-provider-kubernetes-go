...
func (s *jsiiProxy_StatefulSetSpecVolumeClaimTemplateList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_StatefulSetSpecVolumeClaimTemplateList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*StatefulSetSpecVolumeClaimTemplate; received %#v (a %T)", val, val)
		}
	}
