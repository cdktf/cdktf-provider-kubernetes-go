...
type StatefulSetSpecUpdateStrategy struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.20.0/docs/resources/stateful_set#rolling_update StatefulSet#rolling_update}
