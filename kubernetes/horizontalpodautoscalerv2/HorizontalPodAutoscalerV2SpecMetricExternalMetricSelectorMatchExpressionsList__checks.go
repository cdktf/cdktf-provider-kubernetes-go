...
func (h *jsiiProxy_HorizontalPodAutoscalerV2SpecMetricExternalMetricSelectorMatchExpressionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
