...
func (d *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (d *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DataKubernetesPersistentVolumeClaimSpecSelectorOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *DataKubernetesPersistentVolumeClaimSpecSelector, cdktf.IResolvable; received %#v (a %T)", val, val)
		}
	}
