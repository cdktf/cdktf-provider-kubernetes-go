...
type PodSpecVolumeProjectedSources struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/pod#service_account_token Pod#service_account_token}
