...
type PodSpecInitContainerSecurityContextSeccompProfile struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/pod#localhost_profile Pod#localhost_profile}
