...
type PodSpecAffinityNodeAffinityRequiredDuringSchedulingIgnoredDuringExecution struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/pod#node_selector_term Pod#node_selector_term}
