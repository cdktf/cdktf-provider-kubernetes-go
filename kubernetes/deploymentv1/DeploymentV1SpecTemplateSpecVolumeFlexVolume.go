...
type DeploymentV1SpecTemplateSpecVolumeFlexVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/deployment_v1#options DeploymentV1#options}
