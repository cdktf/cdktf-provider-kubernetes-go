...
type DeploymentV1SpecTemplateSpecVolumeVsphereVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/deployment_v1#volume_path DeploymentV1#volume_path}
