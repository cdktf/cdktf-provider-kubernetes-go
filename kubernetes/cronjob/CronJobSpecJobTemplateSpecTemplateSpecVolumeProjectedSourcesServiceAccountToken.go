...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeProjectedSourcesServiceAccountToken struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/cron_job#audience CronJob#audience}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/cron_job#expiration_seconds CronJob#expiration_seconds}
