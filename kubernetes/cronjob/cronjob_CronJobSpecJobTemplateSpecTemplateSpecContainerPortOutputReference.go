...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerPortOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CronJobSpecJobTemplateSpecTemplateSpecContainerPortOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
