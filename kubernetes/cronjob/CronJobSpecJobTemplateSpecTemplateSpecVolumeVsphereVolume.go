...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeVsphereVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.19.0/docs/resources/cron_job#volume_path CronJob#volume_path}
