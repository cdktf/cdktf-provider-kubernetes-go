...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeAwsElasticBlockStore struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.23.0/docs/resources/cron_job#volume_id CronJob#volume_id}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.23.0/docs/resources/cron_job#partition CronJob#partition}
