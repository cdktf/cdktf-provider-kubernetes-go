...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeProjectedSources struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/cron_job#service_account_token CronJob#service_account_token}
