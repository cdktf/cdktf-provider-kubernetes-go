...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeCsi struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.35.0/docs/resources/cron_job#node_publish_secret_ref CronJob#node_publish_secret_ref}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.35.0/docs/resources/cron_job#volume_attributes CronJob#volume_attributes}
