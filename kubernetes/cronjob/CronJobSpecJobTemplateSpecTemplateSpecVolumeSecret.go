...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeSecret struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/cron_job#default_mode CronJob#default_mode}
