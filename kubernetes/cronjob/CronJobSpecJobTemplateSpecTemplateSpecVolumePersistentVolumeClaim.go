...
type CronJobSpecJobTemplateSpecTemplateSpecVolumePersistentVolumeClaim struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.1/docs/resources/cron_job#claim_name CronJob#claim_name}
