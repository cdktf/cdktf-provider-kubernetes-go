...
type CronJobSpecJobTemplateSpecTemplateSpecVolumeFc struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.19.0/docs/resources/cron_job#target_ww_ns CronJob#target_ww_ns}
