...
func (e *jsiiProxy_EndpointsV1SubsetNotReadyAddressList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_EndpointsV1SubsetNotReadyAddressList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*EndpointsV1SubsetNotReadyAddress; received %#v (a %T)", val, val)
		}
	}
