...
func (d *jsiiProxy_DataKubernetesPersistentVolumeV1SpecPersistentVolumeSourceCsiOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
